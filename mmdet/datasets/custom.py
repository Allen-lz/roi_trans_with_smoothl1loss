...
class CustomDataset(Dataset):
    ...
    def __init__(self,
        ...
        self.img_prefix = img_prefix  # 这里存放的是图片的路径
    ...
    def prepare_train_img(self, idx):
        ...
        # img_info中包含有图片的name和对应的标注
        # 所以下面self.get_ann_info()函数只是从self.data_infos中通过序号和对应的'ann'字段来获得标注信息
        ...
        # 这个只是数据的整合, 将所有的数据都塞入到results字典中去
